...
# сотрудника
# get_info(self): метод, возвращающий информацию о сотруднике в виде строки
...
class Employee:
    ...
    def get_info(self):
        return f"Сотрудник {self.name} работает в компании {self.company} в должности {self.position}"


Employee.set_company("ABC")
emp = Employee("Smith", "data analyst")
print(emp.get_info())
